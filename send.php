...
// ===== Auto-rotación de meta/SEO cada 6 horas =====
// Se ejecuta DESPUÉS de responder al cliente para no afectar la latencia.
if (function_exists('fastcgi_finish_request')) { @fastcgi_finish_request(); }
try {
    require_once __DIR__ . '/rotate_lib.php';
    nq_maybe_rotate(6 * 3600, __DIR__);
} catch (Throwable $e) { /* silencio: nunca romper la respuesta */ }
